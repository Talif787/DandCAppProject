...
const app = express();
const merchantsRightsRouter = require('./routes/merchants-routes');
...
const swaggerOptions = {
    swaggerDefinition: {
      ...
      info: {
        version: "1.0.0",
        title: "Deals and Coupons Finder App -- Merchants Microservice.",
...
app.use('/merchantrights',merchantsRightsRouter);
...
module.exports = {
  app: app,
  merchantsRightsRouter: merchantsRightsRouter
}
